...
![Data Jobs Dashboard Page 1](../images/Project1_Dashboard_Overview.gif)
...
- **📊 Core Charts:** Utilized **Column, Bar, Line,** and **Scatter Charts** to compare job counts and track trends over time.
